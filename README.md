...
---
```
đây là bản readme trước đó của tôi hãy sửa nói lại theo những gì code đã làm và thêm nữa giáo viên tôi muốn chuyển nó qua tiếng anh để tiếp cận nhiều người hơn và thầy nói "Source code trên git nên dùng tiếng Anh, cho cả file readme và comment, sẽ tiếp cận được nhiều người đọc hơn. Tôi sẽ gửi lên vài diễn đàn embedded system để giới thiệu đề tài rộng rãi hơn. " 
